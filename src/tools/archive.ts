...
import { renderJsonOutput, sessionExists, type ToolDeps } from '../value.js'

export function applyArchiveTool(ctx: Context, sandbox: SessionSandboxController, deps: ToolDeps): void {
  ctx.tools.register(defineTool({
    ...
    async execute(args, exec) {
      ...
      if (registry === undefined) throw new Error('workspace-unavailable: cannot archive')
