...
export function applyCurrentTool(ctx: Context, sandbox: SessionSandboxController, deps: ToolDeps): void {
  ctx.tools.register(defineTool({
    ...
    async execute(args, exec) {
      ...
      if (agent === undefined) throw new Error('no agent: cannot read the current session')
