...
import { renderJsonOutput, SESSION_SUMMARY_SCHEMA, sessionExists } from '../value.js';
export function applyGetTool(ctx, sandbox, deps) {
    ctx.tools.register(defineTool({
        ...
        async execute(args, exec) {
            ...
            let cwd = agent?.session.header.cwd;
            let workspaceId;
            let workspaceTitle;
